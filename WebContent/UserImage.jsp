	...
	<div id="tooplate_wrapper">
		...
		<div id="tooplate_main_wrapper">
			...
			<div id="tooplate_menu" class="ddsmoothmenu">
				<ul>
					<li><a href="#" class="selected">Upload</a></li>
...
<!-- 					<li class="last"><a href="contact.html" class="last">Contact</a></li> -->
					...
					<tr>
						<td style="color: 999999; line-height: 1.6em">
							<div align="justify">
								...
								<h1 style="color: silver">Choose Your image</h1>



								<form action="EncryptImage" method="post"
									enctype="multipart/form-data">
									<table>
										<tr>
											<td><input type="file" id="filevalues" name="Pdf" accept="image/*" /></td>
										</tr>

										<tr>
											<th style="height: 37px; width: 84px;"><input
												type="submit" value="Submit" onclick="return filevalidate()" /></th>
											<td></td>
										</tr>
	...
	<div id="tooplate_copyright_wrapper">
		<div id="tooplate_copyright">
			Copyright ©  Your Company Name | Design: <a href=""></a>
		</div>
	</div>
